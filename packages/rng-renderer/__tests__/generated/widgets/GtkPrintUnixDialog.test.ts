import { PrintUnixDialog } from "@/generated/widgets.ts"
...
describe("PrintUnixDialog", () => {
  ...
  test("should connect onNotifyCurrentPage", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::currentPage", expect.any(Function))
  })
  ...
  test("should connect onNotifyEmbedPageSetup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::embedPageSetup", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasSelection", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasSelection", expect.any(Function))
  })
  ...
  test("should connect onNotifyManualCapabilities", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::manualCapabilities", expect.any(Function))
  })
  ...
  test("should connect onNotifyPageSetup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::pageSetup", expect.any(Function))
  })
  ...
  test("should connect onNotifyPrintSettings", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::printSettings", expect.any(Function))
  })
  ...
  test("should connect onNotifySelectedPrinter", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::selectedPrinter", expect.any(Function))
  })
  ...
  test("should connect onNotifySupportSelection", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::supportSelection", expect.any(Function))
  })
