import { SearchBar } from "@/generated/widgets.ts"
...
describe("SearchBar", () => {
  ...
  test("should connect onNotifyKeyCaptureWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::keyCaptureWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifySearchModeEnabled", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::searchModeEnabled", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowCloseButton", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showCloseButton", expect.any(Function))
  })
