import { TabBar } from "@/generated/widgets.ts"
...
describe("TabBar", () => {
  ...
  beforeEach(() => {
    widget = new TabBar({}, TabBar.createNode(    ))
  })
  ...
  test("should connect onNotifyAutohide", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::autohide", expect.any(Function))
  })
  ...
  test("should connect onNotifyEndActionWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::endActionWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifyExpandTabs", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::expandTabs", expect.any(Function))
  })
  ...
  test("should connect onNotifyIsOverflowing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::isOverflowing", expect.any(Function))
  })
  ...
  test("should connect onNotifyStartActionWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::startActionWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifyTabsRevealed", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tabsRevealed", expect.any(Function))
  })
