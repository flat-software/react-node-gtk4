...
describe("AlertDialog", () => {
  ...
  beforeEach(() => {
    widget = new AlertDialog({}, AlertDialog.createNode(    ))
  })
  ...
  test("should set preferWideLayout", () => {
    const newValue = true
    widget.set("preferWideLayout", newValue)
    expect(widget.node.setPreferWideLayout).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onNotifyBody", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::body", expect.any(Function))
  })
  ...
  test("should connect onNotifyBodyUseMarkup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::bodyUseMarkup", expect.any(Function))
  })
  ...
  test("should connect onNotifyCloseResponse", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::closeResponse", expect.any(Function))
  })
  ...
  test("should connect onNotifyDefaultResponse", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::defaultResponse", expect.any(Function))
  })
  ...
  test("should connect onNotifyExtraChild", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::extraChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyHeading", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::heading", expect.any(Function))
  })
  ...
  test("should connect onNotifyHeadingUseMarkup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::headingUseMarkup", expect.any(Function))
  })

  test("should connect onNotifyPreferWideLayout", () => {
    const callback = jest.fn()

    widget.set("onNotifyPreferWideLayout", callback)

    const handler = widget.handlers["notify::preferWideLayout"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::preferWideLayout", expect.any(Function))
  })
