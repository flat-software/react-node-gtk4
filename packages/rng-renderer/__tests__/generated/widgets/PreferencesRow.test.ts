import { PreferencesRow } from "@/generated/widgets.ts"
import Gtk from "@/generated/girs/node-gtk-4.0.js"
import GLib from "@/generated/girs/node-glib-2.0.js"

describe("PreferencesRow", () => {
  let widget: PreferencesRow

  beforeEach(() => {
    widget = new PreferencesRow({}, PreferencesRow.createNode(    ))
  })
  ...
  test("should connect onNotifyTitleSelectable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::titleSelectable", expect.any(Function))
  })
