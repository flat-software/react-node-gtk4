...
describe("Banner", () => {
  ...
  test("should connect onButtonClicked", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("button-clicked", expect.any(Function))
  ...
  test("should connect onNotifyButtonLabel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::buttonLabel", expect.any(Function))
  })
  ...
  test("should connect onNotifyButtonStyle", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::buttonStyle", expect.any(Function))
  })
  ...
  test("should connect onNotifyRevealed", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::revealed", expect.any(Function))
  })
