import { NavigationView } from "@/generated/widgets.ts"
...
describe("NavigationView", () => {
  ...
  beforeEach(() => {
    widget = new NavigationView({}, NavigationView.createNode(    ))
  })
  ...
  test("should connect onGetNextPage", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("get-next-page", expect.any(Function))
  ...
  test("should connect onReplaced", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("replaced", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyAnimateTransitions", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::animateTransitions", expect.any(Function))
  })
  ...
  test("should connect onNotifyNavigationStack", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::navigationStack", expect.any(Function))
  })
  ...
  test("should connect onNotifyPopOnEscape", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::popOnEscape", expect.any(Function))
  })
  ...
  test("should connect onNotifyVisiblePage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::visiblePage", expect.any(Function))
  })
  ...
  test("should connect onNotifyVisiblePageTag", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::visiblePageTag", expect.any(Function))
  })
