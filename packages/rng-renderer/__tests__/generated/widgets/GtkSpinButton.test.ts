import { SpinButton } from "@/generated/widgets.ts"
...
describe("SpinButton", () => {
  ...
  test("should connect onChangeValue", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("change-value", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onValueChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("value-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyAdjustment", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::adjustment", expect.any(Function))
  })
  ...
  test("should connect onNotifyClimbRate", () => {
    ...
    const handler = widget.handlers["notify::climbRate"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::climbRate", expect.any(Function))
  })
  ...
  test("should connect onNotifyNumeric", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::numeric", expect.any(Function))
  })
  ...
  test("should connect onNotifySnapToTicks", () => {
    ...
    const handler = widget.handlers["notify::snapToTicks"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::snapToTicks", expect.any(Function))
  })
  ...
  test("should connect onNotifyUpdatePolicy", () => {
    ...
    const handler = widget.handlers["notify::updatePolicy"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::updatePolicy", expect.any(Function))
  })
  ...
  test("should connect onNotifyValue", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::value", expect.any(Function))
  })
