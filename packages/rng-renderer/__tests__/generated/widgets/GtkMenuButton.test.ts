...
describe("MenuButton", () => {
  ...
  test("should connect onNotifyAlwaysShowArrow", () => {
    ...
    const handler = widget.handlers["notify::alwaysShowArrow"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::alwaysShowArrow", expect.any(Function))
  })
  ...
  test("should connect onNotifyPopover", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::popover", expect.any(Function))
  })
  ...
  test("should connect onNotifyPrimary", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::primary", expect.any(Function))
  })
