...
describe("ScrolledWindow", () => {
  ...
  test("should set windowPlacement", () => {
    ...
    expect(widget.node.setPlacement).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onEdgeOvershot", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("edge-overshot", expect.any(Function))
  ...
  test("should connect onEdgeReached", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("edge-reached", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveFocusOut", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-focus-out", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onScrollChild", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("scroll-child", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyHscrollbarPolicy", () => {
    ...
    const handler = widget.handlers["notify::hscrollbarPolicy"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hscrollbarPolicy", expect.any(Function))
  })
  ...
  test("should connect onNotifyKineticScrolling", () => {
    ...
    const handler = widget.handlers["notify::kineticScrolling"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::kineticScrolling", expect.any(Function))
  })
  ...
  test("should connect onNotifyMaxContentHeight", () => {
    ...
    const handler = widget.handlers["notify::maxContentHeight"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::maxContentHeight", expect.any(Function))
  })
  ...
  test("should connect onNotifyMaxContentWidth", () => {
    ...
    const handler = widget.handlers["notify::maxContentWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::maxContentWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyMinContentHeight", () => {
    ...
    const handler = widget.handlers["notify::minContentHeight"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::minContentHeight", expect.any(Function))
  })
  ...
  test("should connect onNotifyMinContentWidth", () => {
    ...
    const handler = widget.handlers["notify::minContentWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::minContentWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyOverlayScrolling", () => {
    ...
    const handler = widget.handlers["notify::overlayScrolling"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::overlayScrolling", expect.any(Function))
  })
  ...
  test("should connect onNotifyPropagateNaturalHeight", () => {
    ...
    const handler = widget.handlers["notify::propagateNaturalHeight"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::propagateNaturalHeight", expect.any(Function))
  })
  ...
  test("should connect onNotifyPropagateNaturalWidth", () => {
    ...
    const handler = widget.handlers["notify::propagateNaturalWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::propagateNaturalWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyVscrollbarPolicy", () => {
    ...
    const handler = widget.handlers["notify::vscrollbarPolicy"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::vscrollbarPolicy", expect.any(Function))
  })
  ...
  test("should connect onNotifyWindowPlacement", () => {
    ...
    const handler = widget.handlers["notify::windowPlacement"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::windowPlacement", expect.any(Function))
  })
