...
describe("IconView", () => {
  ...
  test("should connect onActivateCursorItem", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("activate-cursor-item", expect.any(Function))
  ...
  test("should connect onItemActivated", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("item-activated", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectCursorItem", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("select-cursor-item", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectionChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("selection-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onToggleCursorItem", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("toggle-cursor-item", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyColumnSpacing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::columnSpacing", expect.any(Function))
  })
  ...
  test("should connect onNotifyColumns", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::columns", expect.any(Function))
  })
  ...
  test("should connect onNotifyItemOrientation", () => {
    ...
    const handler = widget.handlers["notify::itemOrientation"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::itemOrientation", expect.any(Function))
  })
  ...
  test("should connect onNotifyItemPadding", () => {
    ...
    const handler = widget.handlers["notify::itemPadding"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::itemPadding", expect.any(Function))
  })
  ...
  test("should connect onNotifyItemWidth", () => {
    ...
    const handler = widget.handlers["notify::itemWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::itemWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::margin", expect.any(Function))
  })
  ...
  test("should connect onNotifyMarkupColumn", () => {
    ...
    const handler = widget.handlers["notify::markupColumn"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::markupColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyPixbufColumn", () => {
    ...
    const handler = widget.handlers["notify::pixbufColumn"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::pixbufColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyRowSpacing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::rowSpacing", expect.any(Function))
  })
  ...
  test("should connect onNotifySelectionMode", () => {
    ...
    const handler = widget.handlers["notify::selectionMode"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::selectionMode", expect.any(Function))
  })
  ...
  test("should connect onNotifySpacing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::spacing", expect.any(Function))
  })
  ...
  test("should connect onNotifyTextColumn", () => {
    ...
    const handler = widget.handlers["notify::textColumn"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::textColumn", expect.any(Function))
  })
