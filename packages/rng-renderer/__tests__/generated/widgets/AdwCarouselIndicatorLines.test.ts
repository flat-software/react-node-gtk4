import { CarouselIndicatorLines } from "@/generated/widgets.ts"
import Adw from "@/generated/girs/node-adw-1.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"

describe("CarouselIndicatorLines", () => {
  let widget: CarouselIndicatorLines

  beforeEach(() => {
    widget = new CarouselIndicatorLines({}, CarouselIndicatorLines.createNode(    ))
  })
  ...
  test("should connect onNotifyCarousel", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::carousel", expect.any(Function))
  })
