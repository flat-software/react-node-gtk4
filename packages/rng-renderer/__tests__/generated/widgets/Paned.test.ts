import { Paned } from "@/generated/widgets.ts"
...
describe("Paned", () => {
  ...
  test("should connect onAcceptPosition", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("accept-position", expect.any(Function))
  ...
  test("should connect onCancelPosition", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("cancel-position", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onCycleChildFocus", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("cycle-child-focus", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onCycleHandleFocus", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("cycle-handle-focus", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveHandle", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-handle", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onToggleHandleFocus", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("toggle-handle-focus", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyEndChild", () => {
    ...
    const handler = widget.handlers["notify::endChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::endChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyMaxPosition", () => {
    ...
    const handler = widget.handlers["notify::maxPosition"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::maxPosition", expect.any(Function))
  })
  ...
  test("should connect onNotifyMinPosition", () => {
    ...
    const handler = widget.handlers["notify::minPosition"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::minPosition", expect.any(Function))
  })
  ...
  test("should connect onNotifyPosition", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::position", expect.any(Function))
  })
  ...
  test("should connect onNotifyPositionSet", () => {
    ...
    const handler = widget.handlers["notify::positionSet"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::positionSet", expect.any(Function))
  })
  ...
  test("should connect onNotifyResizeEndChild", () => {
    ...
    const handler = widget.handlers["notify::resizeEndChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::resizeEndChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyResizeStartChild", () => {
    ...
    const handler = widget.handlers["notify::resizeStartChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::resizeStartChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyShrinkEndChild", () => {
    ...
    const handler = widget.handlers["notify::shrinkEndChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::shrinkEndChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyShrinkStartChild", () => {
    ...
    const handler = widget.handlers["notify::shrinkStartChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::shrinkStartChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyStartChild", () => {
    ...
    const handler = widget.handlers["notify::startChild"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::startChild", expect.any(Function))
  })
  ...
  test("should connect onNotifyWideHandle", () => {
    ...
    const handler = widget.handlers["notify::wideHandle"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::wideHandle", expect.any(Function))
  })
