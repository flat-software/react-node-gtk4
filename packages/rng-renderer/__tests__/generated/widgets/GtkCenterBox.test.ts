...
describe("CenterBox", () => {
  ...
  test("should connect onNotifyBaselinePosition", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::baselinePosition", expect.any(Function))
  })
  ...
  test("should connect onNotifyCenterWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::centerWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifyEndWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::endWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifyShrinkCenterLast", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::shrinkCenterLast", expect.any(Function))
  })
  ...
  test("should connect onNotifyStartWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::startWidget", expect.any(Function))
  })
