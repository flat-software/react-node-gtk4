import { TabView } from "@/generated/widgets.ts"
...
describe("TabView", () => {
  ...
  beforeEach(() => {
    widget = new TabView({}, TabView.createNode(    ))
  })
  ...
  test("should connect onClosePage", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("close-page", expect.any(Function))
  ...
  test("should connect onIndicatorActivated", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("indicator-activated", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageAttached", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-attached", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageDetached", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-detached", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSetupMenu", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("setup-menu", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyDefaultIcon", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::defaultIcon", expect.any(Function))
  })
  ...
  test("should connect onNotifyIsTransferringPage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::isTransferringPage", expect.any(Function))
  })
  ...
  test("should connect onNotifyNPages", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::nPages", expect.any(Function))
  })
  ...
  test("should connect onNotifyNPinnedPages", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::nPinnedPages", expect.any(Function))
  })
  ...
  test("should connect onNotifySelectedPage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::selectedPage", expect.any(Function))
  })
  ...
  test("should connect onNotifyShortcuts", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::shortcuts", expect.any(Function))
  })
