...
describe("BottomSheet", () => {
  ...
  test("should connect onNotifyBottomBar", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::bottomBar", expect.any(Function))
  })
  ...
  test("should connect onNotifyCanOpen", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::canOpen", expect.any(Function))
  })
  ...
  test("should connect onNotifyFullWidth", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fullWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyRevealBottomBar", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::revealBottomBar", expect.any(Function))
  })
  ...
  test("should connect onNotifySheet", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::sheet", expect.any(Function))
  })
  ...
  test("should connect onNotifySheetHeight", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::sheetHeight", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowDragHandle", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showDragHandle", expect.any(Function))
  })
