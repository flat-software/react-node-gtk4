import { AboutDialog } from "@/generated/widgets.ts"
...
describe("AboutDialog", () => {
  ...
  test("should connect onNotifyApplicationIcon", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::applicationIcon", expect.any(Function))
  })
  ...
  test("should connect onNotifyApplicationName", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::applicationName", expect.any(Function))
  })
  ...
  test("should connect onNotifyArtists", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::artists", expect.any(Function))
  })
  ...
  test("should connect onNotifyComments", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::comments", expect.any(Function))
  })
  ...
  test("should connect onNotifyCopyright", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::copyright", expect.any(Function))
  })
  ...
  test("should connect onNotifyDebugInfo", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::debugInfo", expect.any(Function))
  })
  ...
  test("should connect onNotifyDebugInfoFilename", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::debugInfoFilename", expect.any(Function))
  })
  ...
  test("should connect onNotifyDesigners", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::designers", expect.any(Function))
  })
  ...
  test("should connect onNotifyDeveloperName", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::developerName", expect.any(Function))
  })
  ...
  test("should connect onNotifyDevelopers", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::developers", expect.any(Function))
  })
  ...
  test("should connect onNotifyDocumenters", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::documenters", expect.any(Function))
  })
  ...
  test("should connect onNotifyIssueUrl", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::issueUrl", expect.any(Function))
  })
  ...
  test("should connect onNotifyLicense", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::license", expect.any(Function))
  })
  ...
  test("should connect onNotifyLicenseType", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::licenseType", expect.any(Function))
  })
  ...
  test("should connect onNotifyReleaseNotes", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::releaseNotes", expect.any(Function))
  })
  ...
  test("should connect onNotifyReleaseNotesVersion", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::releaseNotesVersion", expect.any(Function))
  })
  ...
  test("should connect onNotifySupportUrl", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::supportUrl", expect.any(Function))
  })
  ...
  test("should connect onNotifyTranslatorCredits", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::translatorCredits", expect.any(Function))
  })
  ...
  test("should connect onNotifyVersion", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::version", expect.any(Function))
  })
  ...
  test("should connect onNotifyWebsite", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::website", expect.any(Function))
  })
