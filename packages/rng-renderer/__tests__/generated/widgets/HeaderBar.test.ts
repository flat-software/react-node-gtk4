...
describe("HeaderBar", () => {
  ...
  test("should connect onNotifyCenteringPolicy", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::centeringPolicy", expect.any(Function))
  })
  ...
  test("should connect onNotifyDecorationLayout", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::decorationLayout", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowBackButton", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showBackButton", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowTitle", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showTitle", expect.any(Function))
  })
  ...
  test("should connect onNotifyTitleWidget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::titleWidget", expect.any(Function))
  })
