...
describe("TreeView", () => {
  ...
  test("should connect onColumnsChanged", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("columns-changed", expect.any(Function))
  ...
  test("should connect onCursorChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("cursor-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onExpandCollapseCursorRow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("expand-collapse-cursor-row", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveCursor", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-cursor", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onRowActivated", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("row-activated", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onRowCollapsed", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("row-collapsed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onRowExpanded", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("row-expanded", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectAll", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("select-all", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectCursorParent", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("select-cursor-parent", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectCursorRow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("select-cursor-row", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onStartInteractiveSearch", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("start-interactive-search", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onTestCollapseRow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("test-collapse-row", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onTestExpandRow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("test-expand-row", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onToggleCursorRow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("toggle-cursor-row", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onUnselectAll", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("unselect-all", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyActivateOnSingleClick", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::activateOnSingleClick", expect.any(Function))
  })
  ...
  test("should connect onNotifyEnableGridLines", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::enableGridLines", expect.any(Function))
  })
  ...
  test("should connect onNotifyEnableSearch", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::enableSearch", expect.any(Function))
  })
  ...
  test("should connect onNotifyEnableTreeLines", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::enableTreeLines", expect.any(Function))
  })
  ...
  test("should connect onNotifyExpanderColumn", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::expanderColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyFixedHeightMode", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fixedHeightMode", expect.any(Function))
  })
  ...
  test("should connect onNotifyHeadersClickable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::headersClickable", expect.any(Function))
  })
  ...
  test("should connect onNotifyHeadersVisible", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::headersVisible", expect.any(Function))
  })
  ...
  test("should connect onNotifyHoverExpand", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hoverExpand", expect.any(Function))
  })
  ...
  test("should connect onNotifyHoverSelection", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hoverSelection", expect.any(Function))
  })
  ...
  test("should connect onNotifyLevelIndentation", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::levelIndentation", expect.any(Function))
  })
  ...
  test("should connect onNotifyReorderable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::reorderable", expect.any(Function))
  })
  ...
  test("should connect onNotifyRubberBanding", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::rubberBanding", expect.any(Function))
  })
  ...
  test("should connect onNotifySearchColumn", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::searchColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowExpanders", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showExpanders", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipColumn", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipColumn", expect.any(Function))
  })
