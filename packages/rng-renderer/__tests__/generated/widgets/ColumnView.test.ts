...
describe("ColumnView", () => {
  ...
  test("should connect onNotifyRowFactory", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::rowFactory", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowColumnSeparators", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showColumnSeparators", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowRowSeparators", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showRowSeparators", expect.any(Function))
  })
  ...
  test("should connect onNotifySorter", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::sorter", expect.any(Function))
  })
