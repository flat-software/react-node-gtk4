...
describe("TextView", () => {
  ...
  test("should connect onBackspace", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("backspace", expect.any(Function))
  ...
  test("should connect onCopyClipboard", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("copy-clipboard", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onCutClipboard", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("cut-clipboard", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onDeleteFromCursor", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("delete-from-cursor", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onExtendSelection", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("extend-selection", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onInsertAtCursor", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("insert-at-cursor", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onInsertEmoji", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("insert-emoji", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveViewport", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-viewport", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPasteClipboard", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("paste-clipboard", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPreeditChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("preedit-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSetAnchor", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("set-anchor", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onToggleCursorVisible", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("toggle-cursor-visible", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onToggleOverwrite", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("toggle-overwrite", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyAcceptsTab", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::acceptsTab", expect.any(Function))
  })
  ...
  test("should connect onNotifyBottomMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::bottomMargin", expect.any(Function))
  })
  ...
  test("should connect onNotifyCursorVisible", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::cursorVisible", expect.any(Function))
  })
  ...
  test("should connect onNotifyIndent", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::indent", expect.any(Function))
  })
  ...
  test("should connect onNotifyJustification", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::justification", expect.any(Function))
  })
  ...
  test("should connect onNotifyLeftMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::leftMargin", expect.any(Function))
  })
  ...
  test("should connect onNotifyMonospace", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::monospace", expect.any(Function))
  })
  ...
  test("should connect onNotifyOverwrite", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::overwrite", expect.any(Function))
  })
  ...
  test("should connect onNotifyPixelsAboveLines", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::pixelsAboveLines", expect.any(Function))
  })
  ...
  test("should connect onNotifyPixelsBelowLines", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::pixelsBelowLines", expect.any(Function))
  })
  ...
  test("should connect onNotifyPixelsInsideWrap", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::pixelsInsideWrap", expect.any(Function))
  })
  ...
  test("should connect onNotifyRightMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::rightMargin", expect.any(Function))
  })
  ...
  test("should connect onNotifyTopMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::topMargin", expect.any(Function))
  })
