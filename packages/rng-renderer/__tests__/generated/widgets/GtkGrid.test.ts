import { Grid } from "@/generated/widgets.ts"
...
describe("Grid", () => {
  ...
  test("should connect onNotifyBaselineRow", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::baselineRow", expect.any(Function))
  })
  ...
  test("should connect onNotifyColumnHomogeneous", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::columnHomogeneous", expect.any(Function))
  })
  ...
  test("should connect onNotifyRowHomogeneous", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::rowHomogeneous", expect.any(Function))
  })
