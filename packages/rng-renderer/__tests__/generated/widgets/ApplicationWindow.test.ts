import { ApplicationWindow } from "@/generated/widgets.ts"
...
describe("ApplicationWindow", () => {
  ...
  test("should connect onActionAdded", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("action-added", expect.any(Function))
  ...
  test("should connect onActionEnabledChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("action-enabled-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onActionRemoved", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("action-removed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onActionStateChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("action-state-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyAdaptivePreview", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::adaptivePreview", expect.any(Function))
  })
  ...
  test("should connect onNotifyDialogs", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::dialogs", expect.any(Function))
  })
  ...
  test("should connect onNotifyVisibleDialog", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::visibleDialog", expect.any(Function))
  })
