import { Carousel } from "@/generated/widgets.ts"
...
describe("Carousel", () => {
  ...
  beforeEach(() => {
    widget = new Carousel({}, Carousel.createNode(    ))
  })
  ...
  test("should connect onPageChanged", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-changed", expect.any(Function))
  ...
  test("should connect onNotifyAllowLongSwipes", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::allowLongSwipes", expect.any(Function))
  })
  ...
  test("should connect onNotifyAllowMouseDrag", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::allowMouseDrag", expect.any(Function))
  })
  ...
  test("should connect onNotifyAllowScrollWheel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::allowScrollWheel", expect.any(Function))
  })
  ...
  test("should connect onNotifyInteractive", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::interactive", expect.any(Function))
  })
  ...
  test("should connect onNotifyRevealDuration", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::revealDuration", expect.any(Function))
  })
  ...
  test("should connect onNotifyScrollParams", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::scrollParams", expect.any(Function))
  })
