import { AppChooserWidget } from "@/generated/widgets.ts"
...
describe("AppChooserWidget", () => {
  ...
  test("should connect onApplicationActivated", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("application-activated", expect.any(Function))
  ...
  test("should connect onApplicationSelected", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("application-selected", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyDefaultText", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::defaultText", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowAll", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showAll", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowDefault", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showDefault", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowFallback", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showFallback", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowOther", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showOther", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowRecommended", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showRecommended", expect.any(Function))
  })
  ...
  test("should connect onNotifyContentType", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::contentType", expect.any(Function))
  })
