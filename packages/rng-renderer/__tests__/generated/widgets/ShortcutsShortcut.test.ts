import { ShortcutsShortcut } from "@/generated/widgets.ts"
...
describe("ShortcutsShortcut", () => {
  ...
  test("should connect onNotifyAccelSizeGroup", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::accelSizeGroup", expect.any(Function))
  })
  ...
  test("should connect onNotifyAccelerator", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::accelerator", expect.any(Function))
  })
  ...
  test("should connect onNotifyDirection", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::direction", expect.any(Function))
  })
  ...
  test("should connect onNotifyIcon", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::icon", expect.any(Function))
  })
  ...
  test("should connect onNotifyIconSet", () => {
    ...
    const handler = widget.handlers["notify::iconSet"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::iconSet", expect.any(Function))
  })
  ...
  test("should connect onNotifyShortcutType", () => {
    ...
    const handler = widget.handlers["notify::shortcutType"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::shortcutType", expect.any(Function))
  })
  ...
  test("should connect onNotifySubtitleSet", () => {
    ...
    const handler = widget.handlers["notify::subtitleSet"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::subtitleSet", expect.any(Function))
  })
  ...
  test("should connect onNotifyTitleSizeGroup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::titleSizeGroup", expect.any(Function))
  })
