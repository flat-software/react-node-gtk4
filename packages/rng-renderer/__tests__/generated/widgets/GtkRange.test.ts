import { Range } from "@/generated/widgets.ts"
...
describe("Range", () => {
  ...
  test("should connect onAdjustBounds", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("adjust-bounds", expect.any(Function))
  ...
  test("should connect onMoveSlider", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-slider", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyFillLevel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fillLevel", expect.any(Function))
  })
  ...
  test("should connect onNotifyRestrictToFillLevel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::restrictToFillLevel", expect.any(Function))
  })
  ...
  test("should connect onNotifyRoundDigits", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::roundDigits", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowFillLevel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showFillLevel", expect.any(Function))
  })
