...
export class ColorChooserWidget<  T extends Gtk.ColorChooserWidget = Gtk.ColorChooserWidget> extends Widget<T> {
  static createNode() {
...
break
      ...
      case "onNotifyShowEditor":
        this.setHandler("notify::showEditor", newValue)
        break
      case "onNotifyName":
      ...
      case "onNotifyUseAlpha":
        this.setHandler("notify::useAlpha", newValue)
        break
