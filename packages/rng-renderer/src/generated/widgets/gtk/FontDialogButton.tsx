...
export class FontDialogButton<  T extends Gtk.FontDialogButton = Gtk.FontDialogButton> extends Widget<T> {
  static createNode() {
...
break
      ...
      case "onNotifyUseFont":
        this.setHandler("notify::useFont", newValue)
        break
      case "onNotifyUseSize":
        this.setHandler("notify::useSize", newValue)
        break
      case "onNotifyName":
