...
import {ListBase} from "./GtkListBase.js"

export class GridView<  T extends Gtk.GridView = Gtk.GridView> extends ListBase<T> {
  static createNode() {
...
break
      ...
      case "onNotifyMaxColumns":
        this.setHandler("notify::maxColumns", newValue)
        break
      case "onNotifyMinColumns":
        this.setHandler("notify::minColumns", newValue)
        break
      case "onNotifyModel":
