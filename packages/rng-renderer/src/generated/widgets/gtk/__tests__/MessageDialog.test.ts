...
describe("MessageDialog", () => {
  ...
  test("should connect onNotifyButtons", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::buttons", expect.any(Function))
  })
  ...
  test("should connect onNotifyMessageArea", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::messageArea", expect.any(Function))
  })
  ...
  test("should connect onNotifyMessageType", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::messageType", expect.any(Function))
  })
  ...
  test("should connect onNotifySecondaryText", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::secondaryText", expect.any(Function))
  })
  ...
  test("should connect onNotifySecondaryUseMarkup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::secondaryUseMarkup", expect.any(Function))
  })
