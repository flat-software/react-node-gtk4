import { ListBox } from "@/generated/widgets.ts"
...
describe("ListBox", () => {
  ...
  test("should connect onActivateCursorRow", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("activate-cursor-row", expect.any(Function))
  ...
  test("should connect onRowSelected", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("row-selected", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectedRowsChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("selected-rows-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
