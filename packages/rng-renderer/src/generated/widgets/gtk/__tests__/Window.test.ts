import { Window } from "@/generated/widgets.ts"
...
describe("Window", () => {
  ...
  test("should set gravity", () => {
    const newValue = Gtk.WindowGravity.TOP_LEFT
    widget.set("gravity", newValue)
    expect(widget.node.setGravity).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onActivateDefault", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("activate-default", expect.any(Function))
  ...
  test("should connect onActivateFocus", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("activate-focus", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onCloseRequest", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("close-request", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onEnableDebugging", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("enable-debugging", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onKeysChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("keys-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyApplication", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::application", expect.any(Function))
  })
  ...
  test("should connect onNotifyDecorated", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::decorated", expect.any(Function))
  })
  ...
  test("should connect onNotifyDefaultHeight", () => {
    ...
    const handler = widget.handlers["notify::defaultHeight"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::defaultHeight", expect.any(Function))
  })
  ...
  test("should connect onNotifyDefaultWidth", () => {
    ...
    const handler = widget.handlers["notify::defaultWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::defaultWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyDeletable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::deletable", expect.any(Function))
  })
  ...
  test("should connect onNotifyDestroyWithParent", () => {
    ...
    const handler = widget.handlers["notify::destroyWithParent"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::destroyWithParent", expect.any(Function))
  })
  ...
  test("should connect onNotifyDisplay", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::display", expect.any(Function))
  })
  ...
  test("should connect onNotifyFocusVisible", () => {
    ...
    const handler = widget.handlers["notify::focusVisible"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::focusVisible", expect.any(Function))
  })
  ...
  test("should connect onNotifyFullscreened", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fullscreened", expect.any(Function))
  })

  test("should connect onNotifyGravity", () => {
    const callback = jest.fn()

    widget.set("onNotifyGravity", callback)

    const handler = widget.handlers["notify::gravity"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::gravity", expect.any(Function))
  })
  ...
  test("should connect onNotifyHandleMenubarAccel", () => {
    ...
    const handler = widget.handlers["notify::handleMenubarAccel"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::handleMenubarAccel", expect.any(Function))
  })
  ...
  test("should connect onNotifyHideOnClose", () => {
    ...
    const handler = widget.handlers["notify::hideOnClose"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hideOnClose", expect.any(Function))
  })
  ...
  test("should connect onNotifyIsActive", () => {
    ...
    const handler = widget.handlers["notify::isActive"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::isActive", expect.any(Function))
  })
  ...
  test("should connect onNotifyMaximized", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::maximized", expect.any(Function))
  })
  ...
  test("should connect onNotifyMnemonicsVisible", () => {
    ...
    const handler = widget.handlers["notify::mnemonicsVisible"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::mnemonicsVisible", expect.any(Function))
  })
  ...
  test("should connect onNotifyResizable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::resizable", expect.any(Function))
  })
  ...
  test("should connect onNotifyStartupId", () => {
    ...
    const handler = widget.handlers["notify::startupId"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::startupId", expect.any(Function))
  })
  ...
  test("should connect onNotifySuspended", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::suspended", expect.any(Function))
  })
  ...
  test("should connect onNotifyTitlebar", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::titlebar", expect.any(Function))
  })
  ...
  test("should connect onNotifyTransientFor", () => {
    ...
    const handler = widget.handlers["notify::transientFor"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::transientFor", expect.any(Function))
  })
