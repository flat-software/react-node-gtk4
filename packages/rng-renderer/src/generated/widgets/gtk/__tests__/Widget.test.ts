import { Widget } from "@/generated/widgets.ts"
...
describe("Widget", () => {
  ...
  test("should connect onDirectionChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("direction-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onKeynavFailed", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("keynav-failed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMnemonicActivate", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("mnemonic-activate", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveFocus", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-focus", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onQueryTooltip", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("query-tooltip", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onStateFlagsChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("state-flags-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onUnrealize", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("unrealize", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyCanFocus", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::canFocus", expect.any(Function))
  })
  ...
  test("should connect onNotifyCanTarget", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::canTarget", expect.any(Function))
  })
  ...
  test("should connect onNotifyCssClasses", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::cssClasses", expect.any(Function))
  })
  ...
  test("should connect onNotifyCssName", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::cssName", expect.any(Function))
  })
  ...
  test("should connect onNotifyCursor", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::cursor", expect.any(Function))
  })
  ...
  test("should connect onNotifyFocusOnClick", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::focusOnClick", expect.any(Function))
  })
  ...
  test("should connect onNotifyFocusable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::focusable", expect.any(Function))
  })
  ...
  test("should connect onNotifyHalign", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::halign", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasDefault", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasDefault", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasFocus", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasFocus", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasTooltip", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasTooltip", expect.any(Function))
  })
  ...
  test("should connect onNotifyHeightRequest", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::heightRequest", expect.any(Function))
  })
  ...
  test("should connect onNotifyHexpand", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hexpand", expect.any(Function))
  })
  ...
  test("should connect onNotifyHexpandSet", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hexpandSet", expect.any(Function))
  })
  ...
  test("should connect onNotifyLayoutManager", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::layoutManager", expect.any(Function))
  })
  ...
  test("should connect onNotifyLimitEvents", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::limitEvents", expect.any(Function))
  })
  ...
  test("should connect onNotifyMarginBottom", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::marginBottom", expect.any(Function))
  })
  ...
  test("should connect onNotifyMarginEnd", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::marginEnd", expect.any(Function))
  })
  ...
  test("should connect onNotifyMarginStart", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::marginStart", expect.any(Function))
  })
  ...
  test("should connect onNotifyMarginTop", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::marginTop", expect.any(Function))
  })
  ...
  test("should connect onNotifyOpacity", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::opacity", expect.any(Function))
  })
  ...
  test("should connect onNotifyOverflow", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::overflow", expect.any(Function))
  })
  ...
  test("should connect onNotifyParent", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::parent", expect.any(Function))
  })
  ...
  test("should connect onNotifyReceivesDefault", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::receivesDefault", expect.any(Function))
  })
  ...
  test("should connect onNotifyRoot", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::root", expect.any(Function))
  })
  ...
  test("should connect onNotifyScaleFactor", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::scaleFactor", expect.any(Function))
  })
  ...
  test("should connect onNotifySensitive", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::sensitive", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipMarkup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipMarkup", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipText", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipText", expect.any(Function))
  })
  ...
  test("should connect onNotifyValign", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::valign", expect.any(Function))
  })
  ...
  test("should connect onNotifyVexpand", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::vexpand", expect.any(Function))
  })
  ...
  test("should connect onNotifyVexpandSet", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::vexpandSet", expect.any(Function))
  })
  ...
  test("should connect onNotifyVisible", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::visible", expect.any(Function))
  })
  ...
  test("should connect onNotifyWidthRequest", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::widthRequest", expect.any(Function))
  })
