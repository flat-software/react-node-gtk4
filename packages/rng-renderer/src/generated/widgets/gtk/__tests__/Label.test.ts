...
describe("Label", () => {
  ...
  test("should connect onActivateCurrentLink", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("activate-current-link", expect.any(Function))
  ...
  test("should connect onNotifyEllipsize", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::ellipsize", expect.any(Function))
  })
  ...
  test("should connect onNotifyJustify", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::justify", expect.any(Function))
  })
  ...
  test("should connect onNotifyLines", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::lines", expect.any(Function))
  })
  ...
  test("should connect onNotifyMnemonicKeyval", () => {
    ...
    const handler = widget.handlers["notify::mnemonicKeyval"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::mnemonicKeyval", expect.any(Function))
  })
  ...
  test("should connect onNotifyMnemonicWidget", () => {
    ...
    const handler = widget.handlers["notify::mnemonicWidget"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::mnemonicWidget", expect.any(Function))
  })
  ...
  test("should connect onNotifyNaturalWrapMode", () => {
    ...
    const handler = widget.handlers["notify::naturalWrapMode"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::naturalWrapMode", expect.any(Function))
  })
  ...
  test("should connect onNotifySelectable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::selectable", expect.any(Function))
  })
  ...
  test("should connect onNotifySingleLineMode", () => {
    ...
    const handler = widget.handlers["notify::singleLineMode"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::singleLineMode", expect.any(Function))
  })
  ...
  test("should connect onNotifyWrap", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::wrap", expect.any(Function))
  })
