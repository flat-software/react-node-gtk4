import { Notebook } from "@/generated/widgets.ts"
...
describe("Notebook", () => {
  ...
  test("should connect onCreateWindow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("create-window", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onFocusTab", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("focus-tab", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageAdded", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-added", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageRemoved", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-removed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageReordered", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("page-reordered", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onReorderTab", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("reorder-tab", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectPage", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("select-page", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSwitchPage", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("switch-page", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyEnablePopup", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::enablePopup", expect.any(Function))
  })
  ...
  test("should connect onNotifyGroupName", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::groupName", expect.any(Function))
  })
  ...
  test("should connect onNotifyPage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::page", expect.any(Function))
  })
  ...
  test("should connect onNotifyScrollable", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::scrollable", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowBorder", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showBorder", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowTabs", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showTabs", expect.any(Function))
  })
  ...
  test("should connect onNotifyTabPos", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tabPos", expect.any(Function))
  })
