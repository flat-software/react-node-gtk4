...
describe("GLArea", () => {
  ...
  test("should connect onCreateContext", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("create-context", expect.any(Function))
  ...
  test("should connect onNotifyAllowedApis", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::allowedApis", expect.any(Function))
  })
  ...
  test("should connect onNotifyApi", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::api", expect.any(Function))
  })
  ...
  test("should connect onNotifyAutoRender", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::autoRender", expect.any(Function))
  })
  ...
  test("should connect onNotifyContext", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::context", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasDepthBuffer", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasDepthBuffer", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasStencilBuffer", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasStencilBuffer", expect.any(Function))
  })
  ...
  test("should connect onNotifyUseEs", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::useEs", expect.any(Function))
  })
