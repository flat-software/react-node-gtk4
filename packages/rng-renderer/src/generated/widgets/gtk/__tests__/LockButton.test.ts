...
describe("LockButton", () => {
  ...
  test("should connect onNotifyPermission", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::permission", expect.any(Function))
  })
  ...
  test("should connect onNotifyTextLock", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::textLock", expect.any(Function))
  })
  ...
  test("should connect onNotifyTextUnlock", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::textUnlock", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipLock", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipLock", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipNotAuthorized", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipNotAuthorized", expect.any(Function))
  })
  ...
  test("should connect onNotifyTooltipUnlock", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::tooltipUnlock", expect.any(Function))
  })
