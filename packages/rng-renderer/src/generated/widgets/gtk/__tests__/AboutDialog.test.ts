...
describe("AboutDialog", () => {
  ...
  test("should connect onNotifyAuthors", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::authors", expect.any(Function))
  })
  ...
  test("should connect onNotifyLogo", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::logo", expect.any(Function))
  })
  ...
  test("should connect onNotifyLogoIconName", () => {
    ...
    const handler = widget.handlers["notify::logoIconName"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::logoIconName", expect.any(Function))
  })
  ...
  test("should connect onNotifyProgramName", () => {
    ...
    const handler = widget.handlers["notify::programName"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::programName", expect.any(Function))
  })
  ...
  test("should connect onNotifySystemInformation", () => {
    ...
    const handler = widget.handlers["notify::systemInformation"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::systemInformation", expect.any(Function))
  })
  ...
  test("should connect onNotifyWebsiteLabel", () => {
    ...
    const handler = widget.handlers["notify::websiteLabel"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::websiteLabel", expect.any(Function))
  })
  ...
  test("should connect onNotifyWrapLicense", () => {
    ...
    const handler = widget.handlers["notify::wrapLicense"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::wrapLicense", expect.any(Function))
  })
