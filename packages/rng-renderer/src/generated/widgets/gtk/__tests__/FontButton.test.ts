...
describe("FontButton", () => {
  ...
  test("should connect onFontSet", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("font-set", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onFontActivated", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("font-activated", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyUseFont", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::useFont", expect.any(Function))
  })
  ...
  test("should connect onNotifyUseSize", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::useSize", expect.any(Function))
  })
  ...
  test("should connect onNotifyFont", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::font", expect.any(Function))
  })
  ...
  test("should connect onNotifyFontDesc", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fontDesc", expect.any(Function))
  })
  ...
  test("should connect onNotifyFontFeatures", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::fontFeatures", expect.any(Function))
  })
  ...
  test("should connect onNotifyLanguage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::language", expect.any(Function))
  })
  ...
  test("should connect onNotifyLevel", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::level", expect.any(Function))
  })
  ...
  test("should connect onNotifyPreviewText", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::previewText", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowPreviewEntry", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showPreviewEntry", expect.any(Function))
  })
