import { ComboBox } from "@/generated/widgets.ts"
...
describe("ComboBox", () => {
  ...
  test("should connect onFormatEntryText", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("format-entry-text", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveActive", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("move-active", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyActive", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::active", expect.any(Function))
  })
  ...
  test("should connect onNotifyActiveId", () => {
    ...
    const handler = widget.handlers["notify::activeId"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::activeId", expect.any(Function))
  })
  ...
  test("should connect onNotifyButtonSensitivity", () => {
    ...
    const handler = widget.handlers["notify::buttonSensitivity"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::buttonSensitivity", expect.any(Function))
  })
  ...
  test("should connect onNotifyEntryTextColumn", () => {
    ...
    const handler = widget.handlers["notify::entryTextColumn"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::entryTextColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyHasEntry", () => {
    ...
    const handler = widget.handlers["notify::hasEntry"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hasEntry", expect.any(Function))
  })
  ...
  test("should connect onNotifyIdColumn", () => {
    ...
    const handler = widget.handlers["notify::idColumn"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::idColumn", expect.any(Function))
  })
  ...
  test("should connect onNotifyPopupFixedWidth", () => {
    ...
    const handler = widget.handlers["notify::popupFixedWidth"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::popupFixedWidth", expect.any(Function))
  })
  ...
  test("should connect onNotifyPopupShown", () => {
    ...
    const handler = widget.handlers["notify::popupShown"]
    expect(handler).toBeDefined()
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::popupShown", expect.any(Function))
  })
