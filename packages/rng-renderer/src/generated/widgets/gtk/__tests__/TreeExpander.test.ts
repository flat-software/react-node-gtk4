...
describe("TreeExpander", () => {
  ...
  test("should connect onNotifyHideExpander", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::hideExpander", expect.any(Function))
  })
  ...
  test("should connect onNotifyIndentForDepth", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::indentForDepth", expect.any(Function))
  })
  ...
  test("should connect onNotifyIndentForIcon", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::indentForIcon", expect.any(Function))
  })
  ...
  test("should connect onNotifyItem", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::item", expect.any(Function))
  })
  ...
  test("should connect onNotifyListRow", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::listRow", expect.any(Function))
  })
