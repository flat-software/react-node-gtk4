...
export class GraphicsOffload<  T extends Gtk.GraphicsOffload = Gtk.GraphicsOffload> extends Widget<T> {
  static createNode() {
...
this.node.setBlackBackground(newValue)
break
case "enabled":
...
break
      case "onNotifyBlackBackground":
        this.setHandler("notify::blackBackground", newValue)
        break
      case "onNotifyChild":
