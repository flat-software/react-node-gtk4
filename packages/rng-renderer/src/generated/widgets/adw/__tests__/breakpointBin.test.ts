...
describe("BreakpointBin", () => {
  ...
  beforeEach(() => {
    widget = new BreakpointBin({}, BreakpointBin.createNode());
  });
  ...
  test("should append child", () => {
    const child = new BreakpointBin({}, BreakpointBin.createNode());
  ...
  test("should insert child before", () => {
    const child = new BreakpointBin({}, BreakpointBin.createNode());
    const sibling = new BreakpointBin({}, BreakpointBin.createNode());
    widget.appendChild(child);
