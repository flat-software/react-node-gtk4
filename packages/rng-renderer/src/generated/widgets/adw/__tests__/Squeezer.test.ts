import { Squeezer } from "@/generated/widgets.ts"
...
describe("Squeezer", () => {
  ...
  test("should connect onNotifyAllowNone", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::allowNone", expect.any(Function))
  })
  ...
  test("should connect onNotifyInterpolateSize", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::interpolateSize", expect.any(Function))
  })
  ...
  test("should connect onNotifySwitchThresholdPolicy", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::switchThresholdPolicy", expect.any(Function))
  })
