...
describe("TabOverview", () => {
  ...
  test("should connect onCreateTab", () => {
    ...
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("create-tab", expect.any(Function))
  ...
  test("should connect onExtraDragDrop", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("extra-drag-drop", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onExtraDragValue", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(widget.node.on).toHaveBeenCalledWith("extra-drag-value", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyEnableNewTab", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::enableNewTab", expect.any(Function))
  })
  ...
  test("should connect onNotifyExtraDragPreferredAction", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::extraDragPreferredAction", expect.any(Function))
  })
  ...
  test("should connect onNotifyExtraDragPreload", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::extraDragPreload", expect.any(Function))
  })
  ...
  test("should connect onNotifyInverted", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::inverted", expect.any(Function))
  })
  ...
  test("should connect onNotifyOpen", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::open", expect.any(Function))
  })
  ...
  test("should connect onNotifySearchActive", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::searchActive", expect.any(Function))
  })
  ...
  test("should connect onNotifySecondaryMenu", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::secondaryMenu", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowEndTitleButtons", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showEndTitleButtons", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowStartTitleButtons", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showStartTitleButtons", expect.any(Function))
  })
  ...
  test("should connect onNotifyView", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::view", expect.any(Function))
  })
