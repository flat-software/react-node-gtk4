...
describe("WrapBox", () => {
  ...
  test("should connect onNotifyAlign", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::align", expect.any(Function))
  })
  ...
  test("should connect onNotifyChildSpacing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::childSpacing", expect.any(Function))
  })
  ...
  test("should connect onNotifyChildSpacingUnit", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::childSpacingUnit", expect.any(Function))
  })
  ...
  test("should connect onNotifyJustifyLastLine", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::justifyLastLine", expect.any(Function))
  })
  ...
  test("should connect onNotifyLineHomogeneous", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::lineHomogeneous", expect.any(Function))
  })
  ...
  test("should connect onNotifyLineSpacing", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::lineSpacing", expect.any(Function))
  })
  ...
  test("should connect onNotifyLineSpacingUnit", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::lineSpacingUnit", expect.any(Function))
  })
  ...
  test("should connect onNotifyNaturalLineLength", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::naturalLineLength", expect.any(Function))
  })
  ...
  test("should connect onNotifyNaturalLineLengthUnit", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::naturalLineLengthUnit", expect.any(Function))
  })
  ...
  test("should connect onNotifyPackDirection", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::packDirection", expect.any(Function))
  })
  ...
  test("should connect onNotifyWrapPolicy", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::wrapPolicy", expect.any(Function))
  })
  ...
  test("should connect onNotifyWrapReverse", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::wrapReverse", expect.any(Function))
  })
