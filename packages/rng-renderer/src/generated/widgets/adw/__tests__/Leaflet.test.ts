...
describe("Leaflet", () => {
  ...
  test("should set modeTransitionDuration", () => {
    ...
    expect(widget.node.setModeTransitionDuration).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onNotifyCanNavigateBack", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::canNavigateBack", expect.any(Function))
  })
  ...
  test("should connect onNotifyCanNavigateForward", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::canNavigateForward", expect.any(Function))
  })
  ...
  test("should connect onNotifyCanUnfold", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::canUnfold", expect.any(Function))
  })
  ...
  test("should connect onNotifyChildTransitionParams", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::childTransitionParams", expect.any(Function))
  })
  ...
  test("should connect onNotifyChildTransitionRunning", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::childTransitionRunning", expect.any(Function))
  })
  ...
  test("should connect onNotifyModeTransitionDuration", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::modeTransitionDuration", expect.any(Function))
  })
