...
describe("Avatar", () => {
  ...
  test("should connect onNotifyCustomImage", () => {
    ...
    expect(widget.node.on).toHaveBeenCalledWith("notify::customImage", expect.any(Function))
  })
  ...
  test("should connect onNotifyShowInitials", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::showInitials", expect.any(Function))
  })
  ...
  test("should connect onNotifySize", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(widget.node.on).toHaveBeenCalledWith("notify::size", expect.any(Function))
  })
