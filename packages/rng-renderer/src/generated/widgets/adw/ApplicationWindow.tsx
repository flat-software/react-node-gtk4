...
import {ApplicationWindow} from "./GtkApplicationWindow.js"

export class ApplicationWindow<  T extends Adw.ApplicationWindow = Adw.ApplicationWindow> extends ApplicationWindow<T> {
  static createNode() {
