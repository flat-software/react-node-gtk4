...
import {AdwPreferencesWindow} from "../adwPreferencesWindow.js";

describe("AdwPreferencesWindow", () => {
  let widget: AdwPreferencesWindow;

  beforeEach(() => {
    widget = new AdwPreferencesWindow({}, AdwPreferencesWindow.createNode());
  });
