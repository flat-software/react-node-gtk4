...
import {AdwPreferencesDialog} from "../adwPreferencesDialog.js";

describe("AdwPreferencesDialog", () => {
  let widget: AdwPreferencesDialog;

  beforeEach(() => {
    widget = new AdwPreferencesDialog({}, AdwPreferencesDialog.createNode());
  });
