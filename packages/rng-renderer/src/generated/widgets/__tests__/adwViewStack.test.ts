...
import {AdwViewStack} from "../adwViewStack.js";

describe("AdwViewStack", () => {
  let widget: AdwViewStack;

  beforeEach(() => {
    widget = new AdwViewStack({}, AdwViewStack.createNode());
  });
