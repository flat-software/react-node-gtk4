...
import {AdwPreferencesPage} from "../adwPreferencesPage.js";

describe("AdwPreferencesPage", () => {
  let widget: AdwPreferencesPage;

  beforeEach(() => {
    widget = new AdwPreferencesPage({}, AdwPreferencesPage.createNode());
  });
