...
import {AdwExpanderRow} from "../adwExpanderRow.js";

describe("AdwExpanderRow", () => {
  let widget: AdwExpanderRow;

  beforeEach(() => {
    widget = new AdwExpanderRow({}, AdwExpanderRow.createNode());
  });
