...
import {AdwInlineViewSwitcher} from "../adwInlineViewSwitcher.js";

describe("AdwInlineViewSwitcher", () => {
  let widget: AdwInlineViewSwitcher;

  beforeEach(() => {
    widget = new AdwInlineViewSwitcher({}, AdwInlineViewSwitcher.createNode());
  });
