...
import {AdwAlertDialog} from "../adwAlertDialog.js";

describe("AdwAlertDialog", () => {
  let widget: AdwAlertDialog;

  beforeEach(() => {
    widget = new AdwAlertDialog({}, AdwAlertDialog.createNode());
  });
