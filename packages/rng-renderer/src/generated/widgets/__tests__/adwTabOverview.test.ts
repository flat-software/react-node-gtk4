...
import {AdwTabOverview} from "../adwTabOverview.js";

describe("AdwTabOverview", () => {
  let widget: AdwTabOverview;

  beforeEach(() => {
    widget = new AdwTabOverview({}, AdwTabOverview.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwTabOverview({}, AdwTabOverview.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwTabOverview({}, AdwTabOverview.createNode());
    const sibling = new AdwTabOverview({}, AdwTabOverview.createNode());
    widget.appendChild(child);
