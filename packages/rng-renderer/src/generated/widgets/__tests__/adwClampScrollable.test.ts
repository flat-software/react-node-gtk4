...
import {AdwClampScrollable} from "../adwClampScrollable.js";

describe("AdwClampScrollable", () => {
  let widget: AdwClampScrollable;

  beforeEach(() => {
    widget = new AdwClampScrollable({}, AdwClampScrollable.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwClampScrollable({}, AdwClampScrollable.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwClampScrollable({}, AdwClampScrollable.createNode());
    const sibling = new AdwClampScrollable({}, AdwClampScrollable.createNode());
    widget.appendChild(child);
