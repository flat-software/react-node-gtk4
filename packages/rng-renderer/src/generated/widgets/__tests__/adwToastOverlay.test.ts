...
import {AdwToastOverlay} from "../adwToastOverlay.js";

describe("AdwToastOverlay", () => {
  let widget: AdwToastOverlay;

  beforeEach(() => {
    widget = new AdwToastOverlay({}, AdwToastOverlay.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwToastOverlay({}, AdwToastOverlay.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwToastOverlay({}, AdwToastOverlay.createNode());
    const sibling = new AdwToastOverlay({}, AdwToastOverlay.createNode());
    widget.appendChild(child);
