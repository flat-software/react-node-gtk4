...
import {AdwNavigationPage} from "../adwNavigationPage.js";

describe("AdwNavigationPage", () => {
  let widget: AdwNavigationPage;

  beforeEach(() => {
    widget = new AdwNavigationPage({}, AdwNavigationPage.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwNavigationPage({}, AdwNavigationPage.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwNavigationPage({}, AdwNavigationPage.createNode());
    const sibling = new AdwNavigationPage({}, AdwNavigationPage.createNode());
    widget.appendChild(child);
