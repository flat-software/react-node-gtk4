...
import {AdwCarouselIndicatorLines} from "../adwCarouselIndicatorLines.js";

describe("AdwCarouselIndicatorLines", () => {
  let widget: AdwCarouselIndicatorLines;

  beforeEach(() => {
    widget = new AdwCarouselIndicatorLines(
      {},
      AdwCarouselIndicatorLines.createNode()
    );
  });
