...
import {AdwViewSwitcherBar} from "../adwViewSwitcherBar.js";

describe("AdwViewSwitcherBar", () => {
  let widget: AdwViewSwitcherBar;

  beforeEach(() => {
    widget = new AdwViewSwitcherBar({}, AdwViewSwitcherBar.createNode());
  });
