...
import {AdwToolbarView} from "../adwToolbarView.js";

describe("AdwToolbarView", () => {
  let widget: AdwToolbarView;

  beforeEach(() => {
    widget = new AdwToolbarView({}, AdwToolbarView.createNode());
  });
  ...
  test("should set extendContentToBottomEdge", () => {
    ...
    expect(widget.node.setExtendContentToBottomEdge).toHaveBeenCalledWith(
      newValue
    );
  });
  ...
  test("should set extendContentToTopEdge", () => {
    ...
    expect(widget.node.setExtendContentToTopEdge).toHaveBeenCalledWith(
      newValue
    );
  });
  ...
  test("should connect onNotifyExtendContentToBottomEdge", () => {
    ...
    expect(callback).toHaveBeenCalled();
    expect(widget.node.on).toHaveBeenCalledWith(
      "notify::extendContentToBottomEdge",
      expect.any(Function)
    );
  });
