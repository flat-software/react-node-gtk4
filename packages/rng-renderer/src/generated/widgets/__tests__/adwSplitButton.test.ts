...
import {AdwSplitButton} from "../adwSplitButton.js";

describe("AdwSplitButton", () => {
  let widget: AdwSplitButton;

  beforeEach(() => {
    widget = new AdwSplitButton({}, AdwSplitButton.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwSplitButton({}, AdwSplitButton.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwSplitButton({}, AdwSplitButton.createNode());
    const sibling = new AdwSplitButton({}, AdwSplitButton.createNode());
    widget.appendChild(child);
