...
import {AdwApplicationWindow} from "../adwApplicationWindow.js";

describe("AdwApplicationWindow", () => {
  let widget: AdwApplicationWindow;

  beforeEach(() => {
    widget = new AdwApplicationWindow({}, AdwApplicationWindow.createNode());
  });
