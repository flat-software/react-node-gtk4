...
import {AdwPreferencesGroup} from "../adwPreferencesGroup.js";

describe("AdwPreferencesGroup", () => {
  let widget: AdwPreferencesGroup;

  beforeEach(() => {
    widget = new AdwPreferencesGroup({}, AdwPreferencesGroup.createNode());
  });
