...
import {AdwButtonRow} from "../adwButtonRow.js";

describe("AdwButtonRow", () => {
  let widget: AdwButtonRow;

  beforeEach(() => {
    widget = new AdwButtonRow({}, AdwButtonRow.createNode());
  });
