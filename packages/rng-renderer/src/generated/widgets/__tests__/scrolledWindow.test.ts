...
import {ScrolledWindow} from "../scrolledWindow.js";
...
describe("ScrolledWindow", () => {
  ...
  test("should set propagateNaturalHeight", () => {
    ...
    expect(widget.node.setPropagateNaturalHeight).toHaveBeenCalledWith(
      newValue
    );
  });
