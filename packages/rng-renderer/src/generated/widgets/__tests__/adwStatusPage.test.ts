...
import {AdwStatusPage} from "../adwStatusPage.js";

describe("AdwStatusPage", () => {
  let widget: AdwStatusPage;

  beforeEach(() => {
    widget = new AdwStatusPage({}, AdwStatusPage.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwStatusPage({}, AdwStatusPage.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwStatusPage({}, AdwStatusPage.createNode());
    const sibling = new AdwStatusPage({}, AdwStatusPage.createNode());
    widget.appendChild(child);
