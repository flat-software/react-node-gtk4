...
import {AdwCarouselIndicatorDots} from "../adwCarouselIndicatorDots.js";

describe("AdwCarouselIndicatorDots", () => {
  let widget: AdwCarouselIndicatorDots;

  beforeEach(() => {
    widget = new AdwCarouselIndicatorDots(
      {},
      AdwCarouselIndicatorDots.createNode()
    );
  });
