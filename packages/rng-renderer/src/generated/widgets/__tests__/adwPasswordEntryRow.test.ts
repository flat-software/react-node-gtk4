...
import {AdwPasswordEntryRow} from "../adwPasswordEntryRow.js";

describe("AdwPasswordEntryRow", () => {
  let widget: AdwPasswordEntryRow;

  beforeEach(() => {
    widget = new AdwPasswordEntryRow({}, AdwPasswordEntryRow.createNode());
  });
