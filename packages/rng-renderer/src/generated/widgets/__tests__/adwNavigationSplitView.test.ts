...
import {AdwNavigationSplitView} from "../adwNavigationSplitView.js";

describe("AdwNavigationSplitView", () => {
  let widget: AdwNavigationSplitView;

  beforeEach(() => {
    widget = new AdwNavigationSplitView(
      {},
      AdwNavigationSplitView.createNode()
    );
  });
