...
describe("AdwDialog", () => {
  let widget: AdwDialog;

  beforeEach(() => {
    widget = new AdwDialog({}, AdwDialog.createNode());
  });
  ...
  test("should append child", () => {
    const child = new AdwDialog({}, AdwDialog.createNode());
  ...
  test("should insert child before", () => {
    const child = new AdwDialog({}, AdwDialog.createNode());
    const sibling = new AdwDialog({}, AdwDialog.createNode());
    widget.appendChild(child);
