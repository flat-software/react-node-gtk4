...
export namespace GObject {
   ...
   */
  function signalAddEmissionHook(
    signalId: number,
    detail: GLib.Quark,
  ...
  function typeAddInstancePrivate(
    classType: GType,
    privateSize: number
  ): number;
  /**
   ...
   */
  function typeClassGet(type: GType): TypeClass;
  /**
   ...
   */
  function typeClassPeek(type: GType): TypeClass | null;
  /**
   ...
   */
  function typeClassPeekStatic(type: GType): TypeClass | null;
  /**
   ...
   */
  function typeDefaultInterfaceGet(gType: GType): TypeInterface;
  /**
  ...
  class TypeClass {
     ...
     * @returns the   #GTypeClass structure for the given type ID or %NULL if the class   does not currently exist or is dynamically loaded
     */
    static peekStatic(type: GType): TypeClass | null;
    /**
     * Increments the reference count of the class structure belonging to
     * `type`.
     *
