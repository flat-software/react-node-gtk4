...
export namespace cairo {
  ...
  interface Glyph {
    // Own fields of cairo-1.0.cairo.Glyph
  ...
  class Glyph {
    // Own properties of cairo-1.0.cairo.Glyph

    static name: string;
  }

  interface TextCluster {
    // Own fields of cairo-1.0.cairo.TextCluster
  ...
  class TextCluster {
    // Own properties of cairo-1.0.cairo.TextCluster
