...
export namespace Gdk {
   ...
   */
  function colorStateGetOklab(): ColorState;
  /**
   ...
   */
  function colorStateGetOklch(): ColorState;
  /**
   ...
   */
  function colorStateGetRec2100Linear(): ColorState;
  /**
   ...
   */
  function colorStateGetRec2100Pq(): ColorState;
  /**
   ...
   */
  function colorStateGetSrgb(): ColorState;
  /**
   ...
   */
  function colorStateGetSrgbLinear(): ColorState;
  /**
  ...
  interface DevicePad extends Device {
    ...
    connect(
      sigName: "notify::active-layout-index",
      callback: (...args: any[]) => void
    ): number;
    on(
      sigName: "notify::active-layout-index",
    ...
    emit(sigName: "notify::active-layout-index", ...args: any[]): void;
    connect(
    ...
    emit(sigName: "notify::layout-names", ...args: any[]): void;
    connect(
  ...
  module CicpParams {
    ...
    interface ConstructorProperties
      extends GObject.Object.ConstructorProperties {
      // Own constructor properties of Gdk-4.0.Gdk.CicpParams
       ...
       * - 18: BT.2100 HLG
       */
      transfer_function?: number | null;
    }
  }

  interface CicpParams {
    // Own properties of Gdk-4.0.Gdk.CicpParams
    ...
    // Owm methods of Gdk-4.0.Gdk.CicpParams
    ...
    // Class property signals of Gdk-4.0.Gdk.CicpParams

    connect(
      sigName: "notify::color-primaries",
      callback: (...args: any[]) => void
    ): number;
    on(
      sigName: "notify::color-primaries",
    ...
    emit(sigName: "notify::color-primaries", ...args: any[]): void;
    connect(
      sigName: "notify::matrix-coefficients",
      callback: (...args: any[]) => void
    ): number;
    on(
      sigName: "notify::matrix-coefficients",
    ...
    emit(sigName: "notify::matrix-coefficients", ...args: any[]): void;
    connect(
      sigName: "notify::range",
      callback: (...args: any[]) => void
    ): number;
    on(
      sigName: "notify::range",
    ...
    connect(
      sigName: "notify::transfer-function",
      callback: (...args: any[]) => void
    ): number;
    on(
      sigName: "notify::transfer-function",
    ...
    emit(sigName: "notify::transfer-function", ...args: any[]): void;
    connect(
      sigName: "notify::__gtype__",
      callback: (...args: any[]) => void
    ): number;
  ...
  class CicpParams extends GObject.Object {
    ...
    // Constructors of Gdk-4.0.Gdk.CicpParams

    constructor(config?: CicpParams.ConstructorProperties);
    /**
    ...
    _init(config?: CicpParams.ConstructorProperties): void;
  }
  ...
  interface FrameClock {
    ...
    getRefreshInfo(
      ...
      /* refreshIntervalReturn */ number,
      /* presentationTimeReturn */ number,
    ];
    /**
  ...
  module MemoryTextureBuilder {
    ...
    interface ConstructorProperties
      extends GObject.Object.ConstructorProperties {
      // Own constructor properties of Gdk-4.0.Gdk.MemoryTextureBuilder
  ...
  interface MemoryTextureBuilder {
    // Own properties of Gdk-4.0.Gdk.MemoryTextureBuilder
    ...
    // Owm methods of Gdk-4.0.Gdk.MemoryTextureBuilder
    ...
    // Class property signals of Gdk-4.0.Gdk.MemoryTextureBuilder
    ...
    emit(sigName: "notify::stride", ...args: any[]): void;
    connect(
      sigName: "notify::update-region",
      callback: (...args: any[]) => void
    ): number;
  ...
  class MemoryTextureBuilder extends GObject.Object {
    ...
    // Constructors of Gdk-4.0.Gdk.MemoryTextureBuilder

    constructor(config?: MemoryTextureBuilder.ConstructorProperties);
    /**
     * Creates a new texture builder.
     * @constructor
     * @returns the new `GdkTextureBuilder`
    ...
    _init(config?: MemoryTextureBuilder.ConstructorProperties): void;
  }
  ...
  interface CicpParamsClass {}

  abstract class CicpParamsClass {
    // Own properties of Gdk-4.0.Gdk.CicpParamsClass

    static name: string;
  }

  interface ColorState {
    // Owm methods of Gdk-4.0.Gdk.ColorState
   ...
   */
  class ColorState {
    // Own properties of Gdk-4.0.Gdk.ColorState

    static name: string;

    // Constructors of Gdk-4.0.Gdk.ColorState
  ...
  interface MemoryTextureBuilderClass {}

  abstract class MemoryTextureBuilderClass {
    // Own properties of Gdk-4.0.Gdk.MemoryTextureBuilderClass
