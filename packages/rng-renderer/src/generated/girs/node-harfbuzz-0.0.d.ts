...
export namespace HarfBuzz {
   ...
   */
  function bufferGetNotFoundVariationSelectorGlyph(
    buffer: buffer_t
  ): codepoint_t;
  /**
   ...
   */
  function bufferGetRandomState(buffer: buffer_t): number;
  /**
   ...
   */
  function bufferSetNotFoundGlyph(
    buffer: buffer_t,
   ...
   */
  function bufferSetNotFoundVariationSelectorGlyph(
    buffer: buffer_t,
    notFoundVariationSelector: codepoint_t
  ): void;
  /**
   ...
   */
  function bufferSetRandomState(buffer: buffer_t, state: number): void;
  /**
   ...
   */
  function faceCreateFromFileOrFail(fileName: string, index: number): face_t;
  /**
   ...
   */
  function faceCreateFromFileOrFailUsing(
    fileName: string,
    index: number,
   ...
   */
  function faceCreateOrFail(blob: blob_t, index: number): face_t;
  /**
   * A thin wrapper around the face loader functions registered with HarfBuzz.
   * If `loader_name` is `NULL` or the empty string, the first available loader
   * is used.
   ...
   */
  function faceCreateOrFailUsing(
    blob: blob_t,
    index: number,
    loaderName: string | null
  ): face_t;
   ...
   */
  function faceListLoaders(): string[];
  /**
   ...
   */
  function faceSetGetTableTagsFunc(
    face: face_t,
   ...
   * @param func The callback function to assign
   */
  function fontFuncsSetDrawGlyphOrFailFunc(
    ffuncs: font_funcs_t,
   ...
   * @param func The callback function to assign
   */
  function fontFuncsSetGlyphHOriginsFunc(
    ffuncs: font_funcs_t,
   ...
   * @param func The callback function to assign
   */
  function fontFuncsSetGlyphVOriginsFunc(
    ffuncs: font_funcs_t,
   ...
   * @param func The callback function to assign
   */
  function fontFuncsSetPaintGlyphOrFailFunc(
    ffuncs: font_funcs_t,
   ...
   */
  function fontIsSynthetic(font: font_t): bool_t;
  /**
   ...
   */
  function fontSetFuncsUsing(font: font_t, name: string): bool_t;
  /**
   ...
   */
  function ftFaceCreateFromBlobOrFail(blob: blob_t, index: number): face_t;
  /**
   * Creates an #hb_face_t face object from the specified
   ...
   * @returns The new face object, or `NULL` if no face is found at the specified index or the file cannot be read.
   */
  function ftFaceCreateFromFileOrFail(fileName: string, index: number): face_t;
  /**
   * Creates an #hb_face_t face object from the specified FT_Face.
   *
   * Note that this is using the FT_Face object just to get at the underlying
  ...
  function otLayoutFeatureGetNameIds(
    ...
    /* returnType */ bool_t,
    /* labelId */ ot_name_id_t | null,
    /* tooltipId */ ot_name_id_t | null,
    /* sampleId */ ot_name_id_t | null,
    /* numNamedParameters */ number | null,
    /* firstParamId */ ot_name_id_t | null,
  ];
  /**
   * Fetches a list of all lookups enumerated for the specified feature, in
  ...
  function otLayoutLookupCollectGlyphs(
    ...
    /* glyphsBefore */ set_t | null,
    /* glyphsInput */ set_t | null,
    /* glyphsAfter */ set_t | null,
    /* glyphsOutput */ set_t | null,
  ];
  /**
   ...
   */
  function otShapePlanGetFeatureTags(
    shapePlan: shape_plan_t,
    startOffset: number
  ): [/* returnType */ number, /* tags */ tag_t[]];
  /**
   ...
   * @param font a font
   */
  function paintPushFontTransform(
    funcs: paint_funcs_t,
    paintData: any | null,
    font: font_t
  ): void;
   ...
   * @param font a font
   */
  function paintPushInverseFontTransform(
    funcs: paint_funcs_t,
    paintData: any | null,
    font: font_t
  ): void;
   ...
   * @param firstGlyph The first glyph ID to query
   * @param glyphStride The stride between successive glyph IDs
   * @param xStride The stride between successive origin X coordinates
   * @param yStride The stride between successive origin Y coordinates
   * @returns `true` if data found, `false` otherwise
   */
